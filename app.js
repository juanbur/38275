...
class Producto { //creo constructor
...
let prod = prompt ('Ingrese producto'); //interaccion con usuario
let cantidad = prompt ('Ingrese Kg.');
let tipo = prompt ('¿Es un producto fresco, congelado o no perecedero?')

productos.push(new Producto(prod, cantidad, tipo));//pushear array

for (const dato of productos){ 
    if (cantidad<3) {
        console.log(dato.prod);
        console.log(dato.cantidad + ' kg.');
        console.log('comentario: Ubicarlo en barra')
    } else {
            if (tipo==='fresco') {
            console.log(dato.prod);
            console.log(dato.cantidad + ' kg.')
            console.log('comentario: Ubicarlo en la cámara de frío')
        } else {
            if (tipo==='congelado') {
                console.log(dato.prod);
                console.log(dato.cantidad + ' kg.');
                console.log('comentario: Ubicarlo en la cámara de congelados')
            } else {
                console.log(dato.prod);
                console.log(dato.cantidad + ' kg.')
                console.log('comentario: Ubicarlo en almacén')
            }
        }
    }
